...
static Test tests[] = {
    ...
    {"\xa5\x64|\xa5[\xd1\xd2]", "cat{lit{\xa5}cc{0x64 0xd1-0xd2}}",
     Regexp::Latin1},
    {"\xa5[\xd1\xd2]|\xa5\x64", "cat{lit{\xa5}cc{0x64 0xd1-0xd2}}",
     Regexp::Latin1},
    ...
    {"\xa5\x64[\xd1\xd2]",
     ...
     "d}cc{0xd1-0xd2}}",
     Regexp::Latin1 | Regexp::FoldCase},
    {"\xa5[\xd1\xd2]\x64", "cat{lit{\xa5}cc{0xd1-0xd2}litfold{d}}",
     Regexp::Latin1 | Regexp::FoldCase},
    {"\xa5\x64|\xa5\xd1", "cat{lit{\xa5}cc{0x44 0x64 0xd1}}",
     Regexp::Latin1 | Regexp::FoldCase},
    {"\xa5\xd1|\xa5\x64", "cat{lit{\xa5}cc{0x44 0x64 0xd1}}",
     Regexp::Latin1 | Regexp::FoldCase},
    {"\xa5\x64|\xa5[\xd1\xd2]", "cat{lit{\xa5}cc{0x44 0x64 0xd1-0xd2}}",
     Regexp::Latin1 | Regexp::FoldCase},
    {"\xa5[\xd1\xd2]|\xa5\x64", "cat{lit{\xa5}cc{0x44 0x64 0xd1-0xd2}}",
     Regexp::Latin1 | Regexp::FoldCase},
};
...
void TestParse(const Test *tests, int ntests, Regexp::ParseFlags flags,
  ...
  for (int i = 0; i < ntests; i++) re[i]->Decref();
  delete[] re;
}
...
TEST(TestParse, FoldCase) {
  TestParse(foldcase_tests, ABSL_ARRAYSIZE(foldcase_tests), Regexp::FoldCase,
            "foldcase");
}
...
TEST(TestParse, Literal) {
  TestParse(literal_tests, ABSL_ARRAYSIZE(literal_tests), Regexp::Literal,
            "literal");
}
...
TEST(TestParse, MatchNL) {
  TestParse(matchnl_tests, ABSL_ARRAYSIZE(matchnl_tests), Regexp::MatchNL,
            "with MatchNL");
}
...
TEST(TestParse, NoMatchNL) {
  TestParse(nomatchnl_tests, ABSL_ARRAYSIZE(nomatchnl_tests),
            Regexp::NoParseFlags, "without MatchNL");
}
...
TEST(TestParse, Prefix) {
  TestParse(prefix_tests, ABSL_ARRAYSIZE(prefix_tests), Regexp::PerlX,
            "prefix");
}
...
TEST(TestParse, Nested) {
  TestParse(nested_tests, ABSL_ARRAYSIZE(nested_tests), Regexp::PerlX,
            "nested");
}
